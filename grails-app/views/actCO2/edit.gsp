...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'actCO2.label', default: 'ActCO2')}" />
    <title>
...
<body>
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <g:form resource="${this.actCO2}" method="PUT" class="card">
                ...
                <g:hasErrors bean="${this.actCO2}">
                    <div class="card-alert alert alert-danger mb-0">
                        <ul>
                            <g:eachError bean="${this.actCO2}" var="error">
                ...
                <div class="card-body">
                    <g:hiddenField name="version" value="${this.actCO2?.version}" />
                    <div class="row">
                      <f:all bean="actCO2" />
                    </div>
                </div>
