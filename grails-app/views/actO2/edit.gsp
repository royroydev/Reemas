...
<body>
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <g:form resource="${this.actO2}" method="PUT" class="card">
                ...
                <g:hasErrors bean="${this.actO2}">
                    <div class="card-alert alert alert-danger mb-0">
                        <ul>
                            <g:eachError bean="${this.actO2}" var="error">
                ...
                <div class="card-body">
                    <g:hiddenField name="version" value="${this.actO2?.version}" />
                    <div class="row">
                      <f:all bean="actO2" />
                    </div>
                </div>
