...
assasjhaahjjhasjahsjahsj
                ...
                <div class="card-footer">
                    <div class="d-flex">
                        <g:form resource="${this.appUserAppRole}" method="DELETE" class="d-flex">

                            <g:link class="btn btn-success" action="edit" resource="${this.appUserAppRole}">
