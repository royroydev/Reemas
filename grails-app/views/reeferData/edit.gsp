...
<body>
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <g:form resource="${this.reeferData}" method="PUT" class="card">
                ...
                <g:hasErrors bean="${this.reeferData}">
                    <div class="card-alert alert alert-danger mb-0">
                        <ul>
                            <g:eachError bean="${this.reeferData}" var="error">
                ...
                <div class="card-body">
                    <g:hiddenField name="version" value="${this.reeferData?.version}" />
                    <div class="row">
                        <f:all bean="reeferData" />
                    </div>
