...
<body>
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <g:form resource="${this.setO2}" method="PUT" class="card">
                ...
                <g:hasErrors bean="${this.setO2}">
                    <div class="card-alert alert alert-danger mb-0">
                        <ul>
                            <g:eachError bean="${this.setO2}" var="error">
                ...
                <div class="card-body">
                    <g:hiddenField name="version" value="${this.setO2?.version}" />
                    <div class="row">
                      <f:all bean="setO2" />
                    </div>
                </div>
