...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'setPoint.label', default: 'SetPoint')}" />
    <title>
...
<body>
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <g:form resource="${this.setPoint}" method="PUT" class="card">
                ...
                <g:hasErrors bean="${this.setPoint}">
                    <div class="card-alert alert alert-danger mb-0">
                        <ul>
                            <g:eachError bean="${this.setPoint}" var="error">
                ...
                <div class="card-body">
                    <g:hiddenField name="version" value="${this.setPoint?.version}" />
                    <div class="row">
                      <f:all bean="setPoint" />
                    </div>
                </div>
