...
<body>
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <g:form resource="${this.supplyTemp}" method="PUT" class="card">
                ...
                <g:hasErrors bean="${this.supplyTemp}">
                    <div class="card-alert alert alert-danger mb-0">
                        <ul>
                            <g:eachError bean="${this.supplyTemp}" var="error">
                ...
                <div class="card-body">
                    <g:hiddenField name="version" value="${this.supplyTemp?.version}" />
                    <div class="row">
                      <f:all bean="supplyTemp" />
                    </div>
                </div>
