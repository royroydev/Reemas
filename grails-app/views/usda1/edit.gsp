...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'usda1.label', default: 'Usda1')}" />
    <title>
...
<body>
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <g:form resource="${this.usda1}" method="PUT" class="card">
                ...
                <g:hasErrors bean="${this.usda1}">
                    <div class="card-alert alert alert-danger mb-0">
                        <ul>
                            <g:eachError bean="${this.usda1}" var="error">
                ...
                <div class="card-body">
                    <g:hiddenField name="version" value="${this.usda1?.version}" />
                    <div class="row">
                      <f:all bean="usda1" />
                    </div>
                </div>
