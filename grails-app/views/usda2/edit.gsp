...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'usda2.label', default: 'Usda2')}" />
    <title>
...
<body>
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <g:form resource="${this.usda2}" method="PUT" class="card">
                ...
                <g:hasErrors bean="${this.usda2}">
                    <div class="card-alert alert alert-danger mb-0">
                        <ul>
                            <g:eachError bean="${this.usda2}" var="error">
                ...
                <div class="card-body">
                    <g:hiddenField name="version" value="${this.usda2?.version}" />
                    <div class="row">
                      <f:all bean="usda2" />
                    </div>
                </div>
